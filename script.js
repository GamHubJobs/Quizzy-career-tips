...
const tips = [
            {
                type: "career",
                title: "CAREER TIP #1",
                prompt: "You disagree with a decision your manager just announced in a team meeting. What's the better way to handle it?",
                mistake: {
                    text: "Voice your disagreement to the room right away, before the meeting moves on."
                },
                approach: {
                    text: "Follow up with your manager privately afterward and share a specific alternative."
                },
                whyItWorks: {
                    text: "Raising concerns privately still gets your input heard, but it avoids putting your manager on the defensive in front of the team — which tends to shut the conversation down instead of opening it up.",
            ...
            },
            {
                type: "career",
                title: "CAREER TIP #2",
                prompt: "You just realized a mistake you made is going to affect a client deadline. What's the smarter move?",
                mistake: {
                    text: "Fix what you can quietly and hope it doesn't come up."
                },
                approach: {
                    text: "Tell your manager right away, explain what happened, and suggest a fix."
                },
                whyItWorks: {
                    text: "The earlier a mistake surfaces, the more options your team has to manage it — owning it builds more trust over time than it costs, while hiding it usually costs more once it's discovered.",
            ...
            },
            {
                type: "career",
                title: "CAREER TIP #3",
                prompt: "You're handed more tasks than you can realistically finish this week. What's the more professional response?",
                mistake: {
                    text: "Take it all on and try to power through without saying anything."
                },
                approach: {
                    text: "Flag it early and ask your manager to help prioritize what matters most."
                },
                whyItWorks: {
                    text: "A manager can't reprioritize a workload they don't know is a problem — raising it early prevents missed deadlines and burnout, and it signals judgment rather than weakness.",
            ...
            },
            {
                type: "career",
                title: "CAREER TIP #4",
                prompt: "Your manager gives you critical feedback on a piece of work. What's the better way to respond in the moment?",
                mistake: {
                    text: "Explain the reasons and context before they finish, so they understand why it happened."
                },
                approach: {
                    text: "Let them finish, ask one clarifying question, then respond."
                },
                whyItWorks: {
                    text: "Listening fully before responding signals openness to growth and gives you the full picture — jumping in early, even with good intentions, tends to read as defensiveness.",
